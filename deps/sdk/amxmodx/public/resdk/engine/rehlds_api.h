...
typedef IHookChain<bool, IGameClient *, resource_t *, uint32_t> IRehldsHook_SV_CheckConsistencyResponse;
typedef IHookChainRegistry<bool, IGameClient *, resource_t *, uint32_t> IRehldsHookRegistry_SV_CheckConsistencyResponse;
...
typedef IHookChain<uint64_t> IRehldsHook_Steam_GSGetSteamID;
typedef IHookChainRegistry<uint64_t> IRehldsHookRegistry_Steam_GSGetSteamID;
...
typedef IHookChain<bool, uint64_t, const char *, uint32_t> IRehldsHook_Steam_GSBUpdateUserData;
typedef IHookChainRegistry<bool, uint64_t, const char *, uint32_t> IRehldsHookRegistry_Steam_GSBUpdateUserData;
...
struct RehldsFuncs_t {
	...
	void(*MSG_WriteSBits)(uint32_t data, int numbits);
